...
import es.kiwi.behavioral.chain_of_responsibility.extension.multi_request_frame.DepManager;
...
public class DepManager2 extends DepManager {
    ...
    private Object myHandler(RequestModel rm) {
        ...
        if (prm.getFee() < 10000) {
            //工作需要嘛，统统同意
            System.out.println("部门经理同意" + prm.getUser() + "预支差旅费用" + prm.getFee() + "元的请求");
            return true;
        } else {
