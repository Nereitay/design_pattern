...
public class DepUserMediatorImpl {
     ...
     * @return 是否已经正确地处理了因撤销部门所引起地与人员的交互
     */
    public boolean deleteDep(String depId) {
        //请注意：为了演示简单，部门撤销后
        //原部门的人员怎么处理等后续业务，这里就不管了

        //1. 到记录部门和人员关系的集合里面，虚招这个部门相关的人员
     ...
     * @return 是否已经正确地处理了因人员离职引起的与部门的交互
     */
     ...
     * @param oldDepId 调换前部门编号
     * @param newDepId 调换后部门编号
