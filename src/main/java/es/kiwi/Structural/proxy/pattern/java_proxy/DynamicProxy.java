package es.kiwi.Structural.proxy.pattern.java_proxy;

import es.kiwi.Structural.proxy.pattern.protection_proxy.Order;
import es.kiwi.Structural.proxy.pattern.protection_proxy.OrderApi;
